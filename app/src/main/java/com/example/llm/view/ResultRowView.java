...
public class ResultRowView extends RelativeLayout {
    ...
    public ResultRowView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ResultRowView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr,0);
    }

    public ResultRowView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        inflate(context, R.layout.classification_result_row, this);
        ...
        try {
            ...
            mProgressBarProgressStateDrawable = progressBarDrawableProgressStateResId != 0
